...
const importCode = `import { ScrollChoreography } from "@/components/ui/scroll-choreography"`
            ...
            props={[
                {
                    ...
                    description: "An object containing the image URLs for each of the four quadrants.",
                },
                {
                    name: "className",
                    type: "string",
