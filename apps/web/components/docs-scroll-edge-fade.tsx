  ...
  return (
    <div
      ...
      className={cn(
        ...
        isTop
          ? "bg-[linear-gradient(to_bottom,#ffffff_0%,#ffffff_55%,transparent_100%)] dark:bg-[linear-gradient(to_bottom,#111111_0%,#111111_50%,transparent_100%)]"
          : "bg-[linear-gradient(to_top,#ffffff_0%,#ffffff_55%,transparent_100%)] dark:bg-[linear-gradient(to_top,#111111_0%,#111111_50%,transparent_100%)]",
        className
      )}
    />
  )
