...
export function HeroButtons() {
    const installCommand = 'npx shadcn@latest add @componentry/magnetic-dock --registry "https://www.componentry.fun/r/registry.json"'
